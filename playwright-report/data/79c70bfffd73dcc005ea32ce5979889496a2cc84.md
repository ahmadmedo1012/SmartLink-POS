...
- Name: accessibility.spec.ts >> Accessibility: POS page ARIA >> customer name input has aria-label
- Location: e2e/accessibility.spec.ts:274:7
...
Call log:
  ...
  - waiting for getByLabel('اسم العميل')
